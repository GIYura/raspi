...
{
	printk("BMP280 DeviceDriver -  Open was called\n");
	return 0;
}
...
{
	printk("BMP280 DeviceDriver -  Close was called\n");
	return 0;
}
...
static int __init ModuleInit(void)
{
	int ret = -1;
	u8 id;
	printk("BMP280 DeviceDriver - Hello Kernel\n");
	...
	printk("BMP280 DeviceDriver - Device Number %d was registered\n", deviceNumber);
